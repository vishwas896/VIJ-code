            ...
            <AnimatePresence mode="wait">
              {success ? (
                ...
                >
                  ...
                  >
                    <GlassButton variant="primary" onClick={() => navigate('/wallet')} icon={<Wallet size={16} />}>
                      Return to Wallet
                    </GlassButton>
                ...
                <motion.div key="checkout">
                  ...
                  >
                    <GlassButton variant="secondary" onClick={() => navigate(-1)} className="payment-action-cancel">Cancel</GlassButton>
