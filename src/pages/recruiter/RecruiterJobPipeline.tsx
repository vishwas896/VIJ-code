      ...
      <div className="recruiter-page-root">
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: '32px' }}>
          ...
          <div style={{ textAlign: 'right' }}>
            <GlassButton variant="secondary" onClick={() => navigate('/recruiter/dashboard')}>Back to Dashboard</GlassButton>
          </div>
        </div>
        ...
        {isEmpty ? (
          <GlassCard className="recruiter-card" style={{ padding: '60px 40px', textAlign: 'center' }}>
            ...
            <GlassButton variant="primary" onClick={() => navigate('/recruiter/jobs/create')}>
              Edit Parameters
            </GlassButton>
          </GlassCard>
        ) : (
                  ...
                  <GlassCard className="candidate-card recruiter-card">
                    ...
                    <div className="candidate-actions">
                      ...
                      <GlassButton 
                        ...
                        onClick={() => navigate('/interview/room-123')}
                      >
