      ...
      <div className="dashboard-grid">
        ...
        <div className="left-pane">
          <div className="pane-header">
            ...
            <GlassButton variant="secondary" className="small-btn" onClick={() => navigate('/recruiter/post-job')}>
              Post New Job Requirement
            </GlassButton>
          </div>
          
          <div className="postings-list">
            <GlassCard className="posting-card active-posting" onClick={() => navigate('/recruiter/jobs/1')}>
