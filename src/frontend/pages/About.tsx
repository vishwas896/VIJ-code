      ...
      <div className="about-page-root">
        ...
        <section className="about-hero">
          ...
          >
            ...
            <div className="about-hero-ctas">
              <GlassButton variant="primary" icon={<ArrowRight size={18} />} onClick={() => navigate('/network')}>
                Explore VIJ
              </GlassButton>
        ...
        <section className="about-closing">
          ...
          >
            ...
            <div className="about-hero-ctas">
              <GlassButton variant="primary" style={{ padding: '16px 32px', fontSize: '18px' }} onClick={() => navigate('/register')}>
                Join VIJ
              </GlassButton>
              <GlassButton variant="secondary" style={{ padding: '16px 32px', fontSize: '18px' }} onClick={() => navigate('/onboarding/parameters')}>
                Build Your Future
              </GlassButton>
            </div>
