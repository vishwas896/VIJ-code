...
export const CompanyPage: React.FC = () => {
  const { companyId } = useParams(); // URL encoded company name
    ...
    <PageTransition>
      <div className="company-page">
        <div className="company-nav-bar">
          <GlassButton variant="secondary" onClick={() => navigate('/companies')} icon={<ArrowLeft size={16} />}>
            Back to Search
          </GlassButton>
        </div>
        ...
        {isLoading ? (
          ...
          <div className="company-error-state">
            ...
            <h2>No Data Found</h2>
            <p>{error}</p>
            <GlassButton onClick={() => navigate('/companies')}>Return to Search</GlassButton>
          </div>
        ) : data ? (
          <>
                ...
                {isAuthenticated ? (
                  ...
                  <GlassCard className="locked-section">
                    <div className="locked-content">
                      ...
                      <GlassButton variant="primary" onClick={() => navigate('/register')}>Create Free Account</GlassButton>
                    </div>
                  </GlassCard>
                )}
                    ...
                    <div className="similar-grid">
                      {relatedCompanies.map((comp) => (
                        <GlassCard 
                          ...
                          onClick={() => navigate(`/company/${encodeURIComponent(comp.title)}`)}
                        >
