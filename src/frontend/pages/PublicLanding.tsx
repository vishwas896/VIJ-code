          ...
          >
            {CATEGORIES.map((cat, i) => (
              <motion.div key={i} variants={staggerItem}>
                <Link to="/jobs" className="category-card-link">
        ...
        <section className="featured-jobs-section">
          <ScrollReveal>
            <div className="section-header">
              ...
              <Link to="/jobs" className="view-all">View All Jobs <span className="arrow">→</span></Link>
            </div>
          </ScrollReveal>
              ...
              <ScrollReveal key={i}>
                <GlassCard className="job-display-card">
                  ...
                  <div className="job-card-footer">
                    ...
                    <Link to="/register" className="apply-btn">Quick Apply</Link>
                  </div>
                </GlassCard>
              </ScrollReveal>
            ))}
          ...
          <ScrollReveal>
            <div className="final-cta-content">
              ...
              <div className="hero-cta-group">
                <Link to="/register" className="primary-cta">Create Free Account →</Link>
                <Link to="/jobs" className="secondary-cta">Browse Opportunities</Link>
              </div>
            </div>
          </ScrollReveal>
        </section>
