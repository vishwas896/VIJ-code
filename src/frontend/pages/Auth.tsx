...
export const Auth: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setTimeout(() => {
      ...
      navigate(role === 'recruiter' ? '/recruiter/dashboard' : '/onboarding/parameters');
    ...
    <div className="auth-root">
      ...
      <header className="global-header">
        ...
        <div className="nav-utilities">
          <Link to="/login"    className="login-trigger-btn">Log In</Link>
          <Link to="/register" className="join-nav-btn">Join Junction</Link>
        </div>
      </header>
        ...
        <div className="auth-right-pane">
          <div className="auth-form-card">
            ...
            <div className="auth-tab-bar">
              <Link to="/login"    className={`auth-tab ${isLogin  ? 'active' : ''}`}>Log In</Link>
              <Link to="/register" className={`auth-tab ${!isLogin ? 'active' : ''}`}>Sign Up</Link>
            </div>
